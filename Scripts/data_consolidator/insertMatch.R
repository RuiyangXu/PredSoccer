...
# check for the existence of our match table and truncate
...
df$home_team_id <- as.integer(df$home_team_id)
df$away_team_id <- as.integer(df$away_team_id)
df$match_date <- as.character(df$match_date)
df$location_id <- as.integer(df$location_id)
df$competition <- as.character(df$competition)
df$winning_team_id <- as.integer(df$winning_team_id)
df$home_team_score <- as.integer(df$home_team_score)
df$away_team_score <- as.integer(df$away_team_score)
